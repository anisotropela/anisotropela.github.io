...
def dillit(language      = 'dk',
    ...
    #                                                                                                                                                                                             Mi    Mo    Je    Kl    Pe
    books = [['2023.12.16', 'Mary Shelly'                                , 'ENG', 'F', 'Frankenstein'                         , 'Frankenstein'                                       , 1818, 240, nan , nan , nan , nan , nan],
             ['2023.11.03', 'Virginie Despentes'                         , 'FRA', 'F', 'Vernon Subutex'                       , 'Vernon Subutex'                                     , 2019, 327, 4.0 , 4.0 , 4.5 , 4.0 , 4.0],
             ['2023.08.11', 'Tove Ditlevsen'                             , 'DEN', 'F', 'Man gjorde et barn fortræd'           , 'A Child was hurt'                                   , 1941, 168, 4.5 , 4.0 , 4.0 , 4.0 , 4.0],
