...
def dillit(language      = 'dk',
    ...
    #                                                                                                                                                                                             Mi    Mo    Je    Kl    Pe
    books = [['2023.08.10', 'Paul Auster'                                , 'USA', 'M', 'Orakelnat'                            , 'Oracle Night'                                       , 2003, 247, nan , nan , nan , nan , nan, ''               ,''],
             ['2023.05.17', 'Pascal Mercier'                             , 'SUI', 'M', 'Perlmanns fortielser'                 , 'Perlmann\'s Silence'                                , 1995, 512, nan , 4.5 , nan , 4.0 , 4.5, ''               ,''], # UD FRA HUKOMMELSEN!!!!
