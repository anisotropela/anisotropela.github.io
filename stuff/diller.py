...
def dillit(language      = 'dk',
    ...
    #                                                                                                                                                                                             Mi    Mo    Je    Kl    Pe
    books = [['2023.10.04', 'Kurt Vonnegut'                              , 'USA', 'M', 'Slagtehal 5'                          , 'Slaughterhouse-Five'                                , 1969, 207, nan , nan , nan , nan , nan, ''               ,''],
             ['2023.08.10', 'Paul Auster'                                , 'USA', 'M', 'Orakelnat'                            , 'Oracle Night'                                       , 2003, 247, 4.0 , 4.0 , 5.0 , nan , 3.5, ''               ,''],
             ['2023.05.17', 'Pascal Mercier'                             , 'SUI', 'M', 'Perlmanns fortielser'                 , 'Perlmann\'s Silence'                                , 1995, 512, nan , 4.0 , nan , 4.5 , 4.5, ''               ,''],
             ['2023.03.22', 'Ernest Hemingway'                           , 'USA', 'M', 'Farvel til våbnene'                   , 'A Farewell to Arms'                                 , 1929, 336, 2   , 2.0 , 5.0 , 1.5 , 2.0, ''               ,''],
             ['2023.02.10', 'Helle Helle'                                , 'DEN', 'F', 'Hafni fortæller'                      , 'Hafni fortæller'                                    , 2023, 180, 3.0 , 3.5 , 2   , 3.5 , 3.5, ''               ,''],
