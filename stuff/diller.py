...
def dillit(language      = 'dk',
    ...
    #                                                                                                                                                                                             Mi    Mo    Je    Kl    Pe
    books = [['2023.08.10', 'Paul Auster'                                , 'USA', 'M', 'Orakelnat'                            , 'Hafni fortæller'                                    , 2023, 180, nan , nan , nan , nan , nan, ''               ,''],
             ['2023.05.17', 'Pascal Mercier'                             , 'SUI', 'M', 'Perlmanns fortielser'                 , 'Perlmann\'s Silence'                                , 2095, 512, nan , 4.5 , nan , 4.0 , 4.5, ''               ,''], # UD FRA HUKOMMELSEN!!!!
             ['2023.03.22', 'Ernest Hemingway'                           , 'USA', 'M', 'Farvel til våbnene'                   , 'A Farewell to Arms'                                 , 1929, 336, 2   , 2.5 , 0   , 2   , 2.5, ''               ,''], # UD FRA HUKOMMELSEN!!!!
             ['2023.02.10', 'Helle Helle'                                , 'DEN', 'F', 'Hafni fortæller'                      , 'Hafni fortæller'                                    , 2023, 180, 3.0 , 3.5 , 2   , 3.5 , 3.5, ''               ,''], # UD FRA HUKOMMELSEN!!!!
