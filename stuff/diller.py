...
def dillit(language      = 'dk',
    ...
    #                                                                                                                                                                                                           Mi    Mo    Je    Kl    Pe
    books = [['2026.06.13', 'Lea Ypi'                                    , 'ALB', 'F', 'Fri: At blive voksen ved historiens afslutning'     , 'Free: Coming of Age at the End of History'          , 2021, 342, nan , nan , nan , nan , nan ,''               ,''],
             ['2026.05.01', 'Hans-Jørgen Nielsen'                        , 'DEN', 'M', 'Fodboldenglen'                                      , 'Fodboldenglen'                                      , 1979, 241, 4.5 , 4.5 , 4.0 , 4.5 , 4.5 ,'Klaus'          ,'Fælledparken'],
             ...
             ['2025.01.11', 'Albert Camus'                               , 'FRA', 'M', 'Den fremmede'                                       , 'The Stranger'                                       , 1942, 144, 4.0 , 3.0 , 4.0 , 3.5 , 3.5, 'Klaus'          ,''],
             ['2024.10.04', 'Kurt Vonnegut'                              , 'USA', 'M', 'Slagtehal 5'                                        , 'Slaughterhouse-Five'                                , 1969, 207, 4.0 , nan , nan , 4.0 , 5.0, 'Peter'          ,'Græsk mad hos Mikkel'],
             ['2024.08.10', 'Paul Auster'                                , 'USA', 'M', 'Orakelnat'                                          , 'Oracle Night'                                       , 2003, 247, 4.0 , 4.0 , 5.0 , nan , 3.5, ''               ,''],
             ['2024.05.17', 'Pascal Mercier'                             , 'SUI', 'M', 'Perlmanns fortielser'                               , 'Perlmann\'s Silence'                                , 1995, 512, nan , 4.0 , nan , 4.5 , 4.5, ''               ,''],
             ['2024.03.22', 'Ernest Hemingway'                           , 'USA', 'M', 'Farvel til våbnene'                                 , 'A Farewell to Arms'                                 , 1929, 336, 2   , 2.0 , 5.0 , 1.5 , 2.0, ''               ,''],
             ['2024.02.10', 'Helle Helle'                                , 'DEN', 'F', 'Hafni fortæller'                                    , 'Hafni fortæller'                                    , 2023, 180, 3.0 , 3.5 , 2   , 3.5 , 3.5, ''               ,''],
             ['2023.12.16', 'Mary Shelly'                                , 'ENG', 'F', 'Frankenstein'                                       , 'Frankenstein'                                       , 1818, 240, 3.5 , 4.5 , 2   , 3   , 4.5, ''               ,''],
             ['2023.11.03', 'Virginie Despentes'                         , 'FRA', 'F', 'Vernon Subutex'                                     , 'Vernon Subutex'                                     , 2019, 327, 4.0 , 4.0 , 5.0 , 4.0 , 4.0, ''               ,''],
             ['2023.08.11', 'Tove Ditlevsen'                             , 'DEN', 'F', 'Man gjorde et barn fortræd'                         , 'Man gjorde et barn fortræd'                         , 1941, 168, 4.5 , 4.0 , 4.0 , 4.0 , 4.0, ''               ,''],
             ...
             ['2019.08.09', 'Sophus Helle og Morten Søndergaard (overs.)', 'SUM', '?', 'Gilgamesh'                                          , 'Gilgamesh'                                          ,-2100, 140, 4   , 5   , 2.5 , 3.5 , 4  , ''               ,''],
             ...
             ['2017.02.10', 'H. P. Lovecraft'                            , 'USA', 'M', 'Cthulhu Kalder og andre noveller'                   , 'The Call of Cthulhu and other short stories'        , 1928, 117, 4.5 , 4.5 , 2   , 4.5 , 4.5, ''               ,''],
             ...
             ['2015.08.28', 'Harper Lee'                                 , 'USA', 'F', 'Dræb ikke en sangfugl'                              , 'To Kill a Mocking Bird'                             , 1960, 307, 3   , 3   , 3.5 , 3   , 3.5, 'Peter'               ,''],
             ['2015.05.14', 'Michel Houellebecq'                         , 'FRA', 'M', 'Kortet og landskabet'                               , 'The Map and the Territory'                          , 2010, 312, 4.5 , 5   , 4   , 4.5 , 4.5, 'Jeff'           ,'Hos Jeff: stegt flæsk og sommerstuvning'],
             ['2015.03.13', 'Joseph Conrad'                              , 'POL', 'M', 'Mørkets hjerte'                                     , 'Heart of Darkness'                                  , 1899, 128, 3   , 3   , 2   , 3.5 , 3  , 'Peter'          ,'Temporada tapasbar'],
             ['2015.01.30', 'Fjodor Dostojevskij'                        , 'RUS', 'M', 'Kældermennesket'                                    , 'Notes from Underground'                             , 1864, 166, 4.5 , 4.5 , 3.5 , 4.5 , 4.5, 'Morten'         ,'Hos Mikkel: vinsmagning'],
             ['2014.12.06', 'Charles Dickens'                            , 'ENG', 'M', 'En fortælling om to byer'                           , 'A Tale of Two Cities'                               , 1859, 440, 3   , 3.5 , 2.5 , 3   , 2.5, 'Peter'          ,'Julemarked i Lübeck'],
             ['2014.09.27', 'Gabriel García Marquéz'                     , 'COL', 'M', '100 års ensomhed'                                   , 'One Hundred Years of Solitude'                      , 1967, 308, 1.5 , 3   , 2   , 3   , 3  , 'Jeff'           ,'Hos Peter: i kælderen'],
             ['2014.06.21', 'Knut Hamsun'                                , 'NOR', 'M', 'Sult'                                               , 'Hunger'                                             , 1890, 108, 4.5 , 4.5 , 5   , 4   , 4.5, 'Morten'         ,'Hos Jeff: köfte og pomfritter'],
             ['2014.06.21', 'Lewis Carroll'                              , 'ENG', 'M', 'Alice i Eventyrland'                                , 'Alice In Wonderland'                                , 1865, 140, 3.5 , 4   , 2.5 , 3.5 , 3.5, 'Peter'          ,'-"-'],
             ['2014.04.17', 'John Steinbeck'                             , 'USA', 'M', 'Øst for Paradis'                                    , 'East Of Eden'                                       , 1952, 579, 4   , 4   , 4   , 4   , 4  , 'Morten+Klaus'   ,'Hos Morten'],
             ['2014.03.22', 'Ernest Hemingway'                           , 'USA', 'M', 'Den gamle mand og havet'                            , 'The Old Man and the Sea'                            , 1952, 112, 3   , 3   , 3   , 3   , 3  , 'Jeff'           ,'Bootleggers ølbar i Holmbladsgade']]
